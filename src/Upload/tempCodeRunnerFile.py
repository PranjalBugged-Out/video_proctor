...
# Frame skipping settings for 4x speed
FRAME_SKIP = 4  
...
class VideoAnalyzer:
    ...
    def draw_metrics_on_frame(self, frame, eye_tracking, head_movement, mouth_movement, cheating_probability):
        ...
        # Cheating probability with color coding
        ...
        # Add talking/laughing counter
        if mouth_movement_count > 0:
            cv2.putText(frame, f"Talking Events: {mouth_movement_count}", 
